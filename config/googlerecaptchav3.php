...
return [
    ...
    */
    ...
    |
    */
    'secret_key' => env('RECAPTCHA_V3_SECRET_KEY', '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'),
    /*
    |--------------------------------------------------------------------------
    | Site Key
    |--------------------------------------------------------------------------
    ...
    |
    */
    'site_key' => env('RECAPTCHA_V3_SITE_KEY', '705907029854-7ihfi1f5aqs814rtsat166bo3rkbbv3b.apps.googleusercontent.com'),
