...
<template>
    <v-text-field @keydown.enter="handleEnter" class="searchbar mb-0 pb-0 min-w-250px lg:min-w-100px" type="text" color="primary" id="searchKeyword" placeholder="Zoek naar sleutelwoord" />
    <v-btn class="py-7 rounded-0 bg-primary w-full lg:w-auto" @click="searchWebsite()">Zoeken</v-btn>
</template>
